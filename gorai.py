...
TARGET_URL = 'https://ggoorr.net/ao'
...
def fetch_article_content(full_url):
    try:
        ...
        return content_html, ['ai']
    except Exception as e:
        return f"<p>Error fetching content: {e}</p>", ['ai']
...
def generate_rss(items):
    fg = FeedGenerator()
    fg.title('Ggoorr ai Feed')
    fg.link(href=BASE_URL)
    fg.description('Latest ai posts from Ggoorr')
    fg.language('ko')
    ...
    fg.rss_file('gorai.xml')
    print("✅ RSS feed created: gorai.xml")
