...
def generate_rss_feed(items, output_file=FEED_FILE):
    ...
    # Channel metadata
    etree.SubElement(channel, "title").text = "FM Korea"
    etree.SubElement(channel, "link").text = "https://fmkorea.com/"
    etree.SubElement(channel, "description").text = "RSS feed generated from FM Korea"
    ...
    for idx, item in enumerate(items):
        ...
        link = (item.get('link') or '').strip() or f"https://fmkorea.com/placeholder/{idx + 1}"
