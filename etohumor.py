...
TARGET_URL = 'https://www.etoland.co.kr/bbs/board.php?bo_table=etohumor07'
...
def generate_rss(items):
    fg = FeedGenerator()
    fg.title('Eto Humor Feed')
    fg.link(href=BASE_URL)
    fg.description('Latest humor posts from etoland')
    fg.language('ko')
    ...
    fg.rss_file('etohumor.xml')
    print("✅ RSS feed created: etohumor.xml")
