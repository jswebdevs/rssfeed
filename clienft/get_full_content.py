...
def get_full_content(post_url, headers):
    try:
        ...
        content_root = soup.find('div', class_='post_article')
        if not content_root:
            ...
            if tag.name == 'img':
                ...
                if not src.startswith('http'):
                    if src.startswith('/F01'):
                        src = 'https://edgio.clien.net' + src
                    else:
                        src = 'https://edgio.clien.net/F01' + src
                tag['src'] = src
                ...
                if poster and not poster.startswith('http'):
                    if poster.startswith('/F01'):
                        poster = 'https://edgio.clien.net' + poster
                    else:
                        poster = 'https://edgio.clien.net/F01' + poster
