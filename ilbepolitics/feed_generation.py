...
def generate_rss_feed(items, output_file=FEED_FILE):
    ...
    etree.SubElement(channel, "link").text = "https://ilbepolitics.com/"
    etree.SubElement(channel, "description").text = "RSS feed generated from ilbepolitics.com"
    ...
    for idx, item in enumerate(items):
        ...
        if item_type == 'article':
            ...
            link = (item.get('link') or '').strip() or f"https://ilbepolitics.com/placeholder/{idx + 1}"
            ...
            link = item.get('src') or f"https://ilbepolitics.com/video/{idx + 1}"
